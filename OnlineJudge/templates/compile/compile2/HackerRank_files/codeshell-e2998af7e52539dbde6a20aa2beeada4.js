...
"function" == typeof define && define.amd ? define("codeshell", [ "jquery", "underscore", "codemirror", "select2", "json2", "jstorage" ], function($, _) {
...
foldCode:!1,
dynamicMode:!1,
languages:[ "c", "cpp", "java", "csharp", "haskell", "php", "python", "perl", "ruby", "bash", "oracle", "mysql", "sql", "clojure", "scala", "code", "text", "brainfuck", "javascript", "d", "go", "lua", "erlang", "sbcl", "ocaml", "pascal", "python3", "groovy", "text_pseudo", "objectivec", "fsharp", "visualbasic", "cobol", "tsql", "lolcode", "smalltalk", "tcl" ],
language:"c",
showTemplate:!0,
...
}(this)), this._bindVersionBall(), this._bindCurrentVersionBall(), e.find(".fork-version").click(function(_this) {
return function(ev) {
var forked_data;
...
tabSize:size
}), this.codeEditor.setOption("tabSize", size)) :void 0;
},
...
opts.mode = this.options.lang_mime_mapping[this.options.language]), opts.readOnly = readOnly, 
CodeMirror.fromTextArea(t, opts);
},
