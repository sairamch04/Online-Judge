...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'compile_contest_problem', 'category', self.gf('django.db.models.fields.TextField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Contest_Problem.category'
        db.alter_column(u'compile_contest_problem', 'category', self.gf('django.db.models.fields.TextField')(max_length=20))
